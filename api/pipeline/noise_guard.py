...
_STOP_WORDS = frozenset(
    {
        ...
        "with", "by", "from", "is", "was", "are", "were", "be", "been", "has",
        "have", "had", "do", "did", "does", "not", "no", "nor", "so", "yet",
        "both", "either", "that", "this", "these", "those", "which", "who",
        "whom", "whose", "what", "where", "when", "why", "how", "all", "any",
        "each", "few", "more", "most", "other", "some", "such", "than", "too",
        "very", "just", "as", "its", "it", "he", "she", "we", "they", "their",
        "our", "your", "my", "his", "her", "i", "am", "into", "about", "up",
        "out", "if", "then", "also", "after", "before",
    }
)
...
class LeakContradictGuard:
    ...
    def keyword_prefilter(
        ...
        return [
            _count_term_hits(text, key_terms) >= self.PREFILTER_THRESHOLD
